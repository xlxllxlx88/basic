 ...
 */
public class CostVO extends SampleDefaultVO {
	...
	private int    sumUseAmt;				// 사용금액
	private int    sumApprAmt;			    // 승인금액
	...
	public int getSumUseAmt() {
		return sumUseAmt;
	}
	public void setSumUseAmt(int sumUseAmt) {
		this.sumUseAmt = sumUseAmt;
	}
	public int getSumApprAmt() {
		return sumApprAmt;
	}
	public void setSumApprAmt(int sumApprAmt) {
		this.sumApprAmt = sumApprAmt;
	}
	public int getNo() {
		return no;
	}
	...
	public String toString() {
		return "CostVO [no=" + no + ", billNum=" + billNum + ", useDt=" + useDt + ", dtlCd=" + dtlCd + ", dtlNm="
				+ dtlNm + ", useAmt=" + useAmt + ", apprAmt=" + apprAmt + ", statusCd=" + statusCd + ", statusNm="
				+ statusNm + ", regDt=" + regDt + ", fileNm=" + fileNm + ", filePath=" + filePath + ", progSeq="
				+ progSeq + ", statusDt=" + statusDt + ", note=" + note + ", uploadFile=" + uploadFile + ", searchYm="
				+ searchYm + ", searchDtlCd=" + searchDtlCd + ", searchStatusCd=" + searchStatusCd + "]";
	}
