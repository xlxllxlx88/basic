...
<head>
    ...
    function fn_costAdd() {
    	...
    	// 9_3_2. 저장할 데이터 post 방식으로 넘기기
    	$("#addForm").prop('action', 'costAdd.do');
...
<form:form commandName="costVO"  id="addForm"  name="addForm" enctype="multipart/form-data">
    <div id="content_pop">
       <!-- 타이틀 -->
       <div id="title">
          <ul>
      ...
      <div id="sysbtn">
         <ul>
         	  <!-- 등록버튼 클릭하면 fn_costAdd() -->
         	  <!-- 9_2. 버튼 만들기 -->
              <li>
            	  <span class="btn_blue_l">
                      <a href="javascript:fn_costAdd();">저장</a>
